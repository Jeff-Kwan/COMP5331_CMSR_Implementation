...
from dataset import PretrainUniSRecDataset
from dataloader import CustomizedTrainDataLoader
from trainer_unis import DDPPretrainTrainer


def pretrain(rank, world_size, dataset, **kwargs):
    dist.init_process_group(backend='nccl', rank=rank, world_size=world_size)
    # configurations initialization
    props = ['../properties/UniSRec.yaml', '../properties/UniSRec_pretrain.yaml']
    # [f'properties/{model_name}.yaml'] + ['properties/UniSRec_pretrain.yaml']
    if rank == 0:
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', type=str, default='us', help='dataset name')
