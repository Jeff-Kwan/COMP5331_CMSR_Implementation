...
if __name__ == '__main__':
    ...
    parser.add_argument('--seed', default=3407, type=int, help='random seed for reproducibility') #set seed to 3407
    ...
    config = Config(model=CATSR2, config_dict=config_dict,
    ...
    model = CATSR2(config, train_data.dataset).to(config['device'])
    logger.info(model)
