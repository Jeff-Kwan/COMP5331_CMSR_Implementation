...
def merge_and_save(dataset_names, input_path, output_path):
    ...
    short_name = ''.join([_ for _ in dataset_names])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', type=str, default='./downstream/')
    parser.add_argument('--output_path', type=str, default='./downstream/')
    args = parser.parse_args()

    market_list = ['ca', 'de', 'fr', 'in', 'jp', 'mx', 'uk', 'us']
    # markets='ca,de,fr,in,jp,mx,uk,us'
    for m in market_list:
        merge_and_save(m, args.input_path, args.output_path)